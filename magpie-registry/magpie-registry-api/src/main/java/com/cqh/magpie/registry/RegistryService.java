 ...
 *
 * @see com.cqh.magpie.registry.Registry
 * @see com.cqh.magpie.registry.RegistryFactory#getRegistry(URL)
 */
public interface RegistryService {
     ...
     * @return The registered information list, which may be empty, the meaning is the same as the parameters of {@link com.cqh.magpie.registry.NotifyListener#notify(List<URL>)}.
     * @see com.cqh.magpie.registry.NotifyListener#notify(List)
     */
