...
public class Constants {
    ...
    public static final String METHODS_SPLIT_KEY=",";
    ...
    public static final String REGISTER_BEAN_NAME="magpieRegistry";
    public static final String CONSUMER_CONFIG_BEAN_NAME="magpieConsumer";
    public static final String PROVIDER_CONFIG_BEAN_NAME="magpieProvider";
    /*
     * private Constants(){ }
     */
